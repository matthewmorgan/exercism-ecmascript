...
describe('SumOfMultiples', function () {
  it('to 1', function () {
    expect((0, _sumOfMultiples2['default'])().to(1)).toBe(0);
  });

  it('to 3', function () {
    expect((0, _sumOfMultiples2['default'])().to(4)).toBe(3);
  });

  it('to 10', function () {
    expect((0, _sumOfMultiples2['default'])().to(10)).toBe(23);
  });

  it('to 100', function () {
    expect((0, _sumOfMultiples2['default'])().to(100)).toBe(2318);
  });

  it('to 1000', function () {
    expect((0, _sumOfMultiples2['default'])().to(1000)).toBe(233168);
  });
